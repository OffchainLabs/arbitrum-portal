...
export const TeamWidget = ({ project }: { project: FullProject }) => {
  const teamInformationAvailable = project.links.fundingNews || project.meta.foundedDate;
  ...
  return (
    <ProjectWidget>
      ...
      {project.links.fundingNews && (
        <ProjectWidget.CTA link={project.links.fundingNews} analyticsTitle="Crunchbase">
          <Image src={'/images/crunchbase.webp'} width={18} height={18} alt="Crunchbase Logo" />
          Crunchbase
        </ProjectWidget.CTA>
      )}
    </ProjectWidget>
