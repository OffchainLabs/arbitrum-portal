...
export const useBookmarkedProjects = () => {
  ...
  const [_bookmarkedProjectIds, setBookmarkedProjectIds] = useLocalStorage<string[]>(
  ...
  const addBookmarkedProject = (projectId: string, analyticsProps?: AnalyticsProps) => {
  ...
  const removeBookmarkedProject = (projectId: string, analyticsProps?: AnalyticsProps) => {
