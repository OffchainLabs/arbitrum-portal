function MobilePositionCardSkeleton() {
  return (
  ...
  return (
    <div className="flex flex-col gap-6 animate-pulse">
      <div className="flex flex-col gap-4">
        <div className="w-full bg-neutral-50 rounded px-4 py-6 flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4 lg:hidden">
          {[...Array(2)].map((_, cardIndex) => (
            <div key={cardIndex} className="bg-neutral-50 rounded px-4 py-6 flex flex-col gap-3">
      ...
      <div>
        <div className="md:hidden flex flex-col gap-1">
          {[...Array(5)].map((_, cardIndex) => (
            <MobilePositionCardSkeleton key={cardIndex} />
          ))}
        </div>
        ...
        <div className="hidden md:flex overflow-x-auto">
          <div className="flex flex-col gap-1 min-w-[900px] w-full">
            ...
            {[...Array(5)].map((_, rowIndex) => (
              <DesktopOpportunityRowSkeleton key={rowIndex} />
            ))}
          </div>
        </div>
      </div>
