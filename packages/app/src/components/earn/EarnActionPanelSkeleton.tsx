...
export function EarnActionPanelSkeleton() {
  return (
    <Card className="bg-[#191919] rounded-lg flex flex-col gap-4 p-4 animate-pulse">
      ...
      <div className="bg-[#212121] rounded-lg flex flex-col p-4 gap-2">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="bg-[#333333] rounded-lg flex gap-2 items-center px-[10px] py-[5px]">
