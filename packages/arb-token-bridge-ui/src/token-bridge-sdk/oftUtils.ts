...
export function getOftV2TransferConfig({
  ...
  const destinationChainLzEndpointId = oftProtocolConfig[destinationChainId]?.lzEndpointId;
...
export const getOftV2TransferDecodedData = async (txId: string, sourceChainProvider: Provider) => {
