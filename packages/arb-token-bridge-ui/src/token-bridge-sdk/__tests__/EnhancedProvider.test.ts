...
const testTxReceipt: TransactionReceipt = {
  ...
  logsBloom: '',
  blockHash: '',
  transactionHash: '0x40c993848fc927ced60283b2188734b50e736d305d462289cbe231876c6570a8',
  logs: [],
  blockNumber: 7483636,
  confirmations: 19088,
...
describe('EnhancedProvider', () => {
  ...
  it('should fetch real transaction and use cache for subsequent requests', async () => {
    ...
    const txHash = '0x019ae29f37f27399fc2ac3f640b05e7e3700c75759026a4b4d51d7e572480e4c';
  ...
  describe('Caching condition tests', () => {
    ...
    beforeEach(async () => {
      provider = new EnhancedProvider('https://mock.url', ChainId.Sepolia, storage);
    ...
    it('should cache receipt when confirmations are above threshold', async () => {
      ...
      vi.spyOn(StaticJsonRpcProvider.prototype, 'getTransactionReceipt').mockResolvedValue(
        mockReceipt,
      );

      const receipt = await provider.getTransactionReceipt(mockReceipt.transactionHash);
