...
const starter = new CctpTransferStarter({
  sourceChainProvider: new StaticJsonRpcProvider('https://sepolia.gateway.tenderly.co'),
  destinationChainProvider: new StaticJsonRpcProvider('https://sepolia-rollup.arbitrum.io/rpc'),
});
