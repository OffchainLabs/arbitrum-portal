  ...
  describe('disableTransfersToNonArbitrumChains', () => {
    describe('when `disableTransfersToNonArbitrumChains` is true', () => {
      describe('when `sourceChainId` is Arbitrum and `destinationChainId` is undefined', () => {
        it('should not include non-Arbitrum networks as destination when transfers to non-Arbitrum chains are disabled', () => {
          ...
          expect(isNetwork(resultWithLifi.destinationChainId).isNonArbitrumNetwork).toBe(false);
          ...
          // Should not default to a non-Arbitrum network
          expect(isNetwork(resultWithoutLifi.destinationChainId).isNonArbitrumNetwork).toBe(false);
          ...
          // Should not default to a non-Arbitrum network
          expect(isNetwork(result.destinationChainId).isNonArbitrumNetwork).toBe(false);
        });
      ...
      describe('when `destinationChainId` is Arbitrum and `sourceChainId` is undefined', () => {
        it('should not include non-Arbitrum networks as source when transfers to non-Arbitrum chains are disabled', () => {
          ...
          // Should not default to a non-Arbitrum network
          expect(isNetwork(resultWithLifi.sourceChainId).isNonArbitrumNetwork).toBe(false);
          ...
          // Should not default to a non-Arbitrum network
          expect(isNetwork(resultWithoutLifi.sourceChainId).isNonArbitrumNetwork).toBe(false);
    ...
    describe('when `disableTransfersToNonArbitrumChains` is false (default behavior)', () => {
      it('should include non-Arbitrum networks as destination for Arbitrum chains', () => {
        ...
        expect(isNetwork(resultWithLifi.destinationChainId).isNonArbitrumNetwork).toBe(true);
        ...
        expect(isNetwork(resultWithoutLifi.destinationChainId).isNonArbitrumNetwork).toBe(true);
        ...
        expect(isNetwork(result.destinationChainId).isNonArbitrumNetwork).toBe(true);
      });
      ...
      it('should include non-Arbitrum networks as source for Arbitrum chains', () => {
        ...
        expect(isNetwork(resultWithLifi.sourceChainId).isNonArbitrumNetwork).toBe(true);
        ...
        expect(isNetwork(resultWithoutLifi.sourceChainId).isNonArbitrumNetwork).toBe(true);
    ...
    describe('cache behavior with `disableTransfersToNonArbitrumChains`', () => {
      it('should cache results separately for different disableTransfersToNonArbitrumChains values', () => {
        ...
        expect(endtimeWithCache - startTimeWithCache).toBeLessThan(endTime - startTime);
        ...
        expect(endtimeWithCache2 - startTimeWithCache2).toBeLessThan(endTime2 - startTime2);
