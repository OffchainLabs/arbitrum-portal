...
describe('formatAmount', () => {
  describe('for short token symbol', () => {
    ...
    const getResultFromNumber = (value: number) => formatAmount(value, { symbol: 'TOK' });
    ...
    it('should return the shortened number without decimals for value >= 1,000,000', () => {
      ...
      expect(getResultFromBigNumber('123456789012345678901')).toBe('123.457T TOK');
      ...
      expect(getResultFromBigNumber('1234567890123456789012')).toBe('1234.568T TOK');
      expect(getResultFromBigNumber('12345678901234567890123')).toBe('12,345.679T TOK');
      expect(getResultFromNumber(1234567890123456.789012)).toBe('1234.568T TOK');
      expect(getResultFromNumber(12345678901234567.890123)).toBe('12,345.679T TOK');
    });
  });
  ...
  describe('for long token name', () => {
    ...
    const getResultFromNumber = (value: number) => formatAmount(value, { symbol: 'LONGTOKEN' });
    ...
    it('should return the shortened number without decimals for any value', () => {
      ...
      expect(getResultFromBigNumber('12345678901234567')).toBe('12.3B LONGTOKEN');
      expect(getResultFromBigNumber('123456789012345678')).toBe('123.5B LONGTOKEN');
      ...
      expect(getResultFromBigNumber('1234567890123456789')).toBe('1.2T LONGTOKEN');
      expect(getResultFromBigNumber('12345678901234567890')).toBe('12.3T LONGTOKEN');
      expect(getResultFromBigNumber('123456789012345678901')).toBe('123.5T LONGTOKEN');
      ...
      expect(getResultFromNumber(123456789012345.678901)).toBe('123.5T LONGTOKEN');

      expect(getResultFromBigNumber('1234567890123456789012')).toBe('1234.6T LONGTOKEN');
      expect(getResultFromBigNumber('12345678901234567890123')).toBe('12,345.7T LONGTOKEN');
      expect(getResultFromBigNumber('123456789012345678901234')).toBe('123,456.8T LONGTOKEN');
      expect(getResultFromBigNumber('1234567890123456789012345')).toBe('1,234,567.9T LONGTOKEN');
      expect(getResultFromNumber(1234567890123456.789012)).toBe('1234.6T LONGTOKEN');
      expect(getResultFromNumber(12345678901234567.890123)).toBe('12,345.7T LONGTOKEN');
