    ...
    expect(result).toEqual(
      expect.arrayContaining([
        expect.objectContaining({
          transactionHash: '0x49db903399a3b4caa9d99bbac4ca704bd4bad3d247c2d26ccdd0296c96ebf7dd',
        }),
        expect.objectContaining({
          transactionHash: '0x6429e7cb8fa7f501d336ec0672755404c9021abe5d19ae07ad875ad2f1ae6537',
        }),
      ]),
    );
  });
