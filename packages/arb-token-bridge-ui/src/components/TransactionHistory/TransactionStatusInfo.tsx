  ...
  if (numClaimableTransactions > 0 && numRetryablesToRedeem > 0) {
    return (
      <div className="flex space-x-2">
        ...
        <span>
          Time sensitive: You must <span className="font-bold">{numRetryablesToRedeemString}</span>{' '}
          and <span className="font-bold">{numClaimableTransactionsString}</span>
        </span>
      </div>
    );
  }
  ...
  if (numRetryablesToRedeem > 0) {
    return (
      <div className="flex space-x-2">
        <ExclamationTriangleIcon width={20} />
        <span>
          You must <span className="font-bold">{numRetryablesToRedeemString}</span>
        </span>
      </div>
    );
  }
  ...
  if (numClaimableTransactions > 0) {
    return (
      <div className="flex space-x-2">
        <ExclamationTriangleIcon width={20} />
        <span>
          You must <span className="font-bold">{numClaimableTransactionsString}</span>
        </span>
      </div>
    );
  }
  ...
  if (numPendingTransactions > 0) {
    return (
      <div className="flex space-x-2">
        ...
        <span>
          You have <span className="font-bold">{numPendingTransactionsString}</span>
        </span>
      </div>
    );
  }
