        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center text-center sm:p-4">
            <Transition.Child
              ...
              afterLeave={reset}
            >
              <Dialog.Panel className="bg-dark h-screen w-screen transform overflow-hidden rounded border border-white/10 p-4 text-left align-middle shadow shadow-white/10 transition-all sm:h-auto sm:w-full sm:max-w-[488px]">
                <Dialog.Title
