        ...
        return (
          <div className="mb-4">
            ...
            <ol>
              ...
              <li>2. The initial bridge is more expensive than following ones</li>
            </ol>
          </div>
        );
    }
  ...
  return (
    <Dialog {...props} title={title} className="flex flex-col gap-4">
      ...
      <NoteBox variant="error">
        <p className="mb-2">
          <span className="font-medium">Do not bridge</span> if your token does something
          non-standard like generates passive interest or is a rebasing stablecoin.
        </p>
