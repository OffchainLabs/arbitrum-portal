...
export function CustomDestinationAddressConfirmationDialog(props: UseDialogProps) {
  ...
  return (
    ...
    >
      <div className="mb-4">
        ...
        <p className="pb-2">
          This is an uncommon action since it&apos;s not guaranteed that you have a smart contract
          wallet at the same address on the destination chain.
        </p>
      </div>
        ...
        <Checkbox
          label={
            <span className="font-light">
              I confirm that I have full control over the entered destination address on{' '}
              {networkName} and understand that proceeding without control may result in an{' '}
