...
export const NoteBox = ({ children, variant = 'info', className }: NoteBoxProps) => {
  return (
    <div
      className={twMerge(
    ...
    >
      {variant === 'info' && <InformationCircleIcon className={iconClassName} />}
      {variant === 'warning' && <ExclamationTriangleIcon className={iconClassName} />}
